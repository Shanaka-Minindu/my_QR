...
import {
  ...
  FindRedirectUrl,
  updateUrl,
} from "../controllers/qrUrlController.js";
import {
  allQrSub,
  singleQrSub,
  allQrInfo,
...
router.get("/adminqrdata", auth, adminQrData);
router.get("/adminuserdata", auth, adminUserData);
router.get("/adminpaylog", auth, adminPayLog);
router.put("/adminupqr", auth, updateQrdata);
